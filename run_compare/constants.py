...
import numpy as np
CACHE_AUTH_FILE = os.getenv("STRAVA_TOKEN_FILE", "global.json")
...
REDIRECT_URI = 'http://localhost:3476/authorization_successful' if os.getenv('local') == 'true' else 'https://hms-thinkcentre-m93p.taile37d5a.ts.net/authorization_successful/'
DEBUG = True
